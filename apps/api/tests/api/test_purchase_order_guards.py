...
Found by auditing `purchase-orders/` before building the purchasing restructure
over it (roadmap, 2026-09-19) -- the habit that has found defects every time it
has been applied. Each test here was run against the code as it stood and seen
